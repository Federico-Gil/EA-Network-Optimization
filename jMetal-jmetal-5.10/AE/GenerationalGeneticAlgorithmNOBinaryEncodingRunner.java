...
public class GenerationalGeneticAlgorithmNOBinaryEncodingRunner {
	...
	private static final String NOMBRE_ARCHIVO = "C:/Users/Fede/Desktop/AE/EA-Network-Optimization/Network reliability optimization/data/24-nodesWc.csv";
  ...
  private static void validate(BinarySolution solution) {
	  Grafo grafo; 
	  Set<Edge> asd = readEdges("C:/Users/Fede/Desktop/AE/EA-Network-Optimization/Network reliability optimization/data/24-nodesWc.csv");
	...
	//}
	  ...
	  try {
		FileWriter writer = new FileWriter("C:/Users/Fede/Desktop/AE/EA-Network-Optimization/Network reliability optimization/data/newEdges.csv");
		for(Edge e : nuevasAristas) {
